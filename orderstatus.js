            ...
            case 'state': 
                ...
                switch(field) { //if the order is unshipped, we add an extra message - if not, we just close it
                    ...
                    case 'unshipped':
                        ...
                        state += `<em>Your order is either still on pre-order, or pending shipment within our shipping queue. All fully in-stock orders are estimated to take 5-7 business days to process before shipment. Pre-order processing times vary by product — please refer to the product page for the expected ship date.<br><br>You will receive a shipping confirmation email with your tracking information as soon as your order has shipped. You will also be able to view tracking information on this page once that happens.</em></div>`
                    break
